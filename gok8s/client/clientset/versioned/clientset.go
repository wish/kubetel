...
type Interface interface {
	...
	Custom() customv1.CustomV1Interface
}
...
// Deprecated: Custom retrieves the default version of CustomClient.
// Please explicitly pick a version.
func (c *Clientset) Custom() customv1.CustomV1Interface {
	return c.customV1
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.customV1, err = customv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.customV1 = customv1.NewForConfigOrDie(c)
